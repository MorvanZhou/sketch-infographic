...
| | **sketch-infographic**（本项目） | Mermaid | AI 生图 | Excalidraw / draw.io |
|---|---|---|---|---|
| **能力范围** | Agent 自动出图，可绘制图形 | 固定图式（流程/时序等） | 画面自由，结构难控 | 自由绘制，靠手工 |
| **可维护性** | 源码/SVG 可 diff、可重渲 | 文本可 diff | 难精确改、难复现 | 可存文件，难脚本复现 |
| **经济性** | 本地重渲，**省 Token** | 改 DSL 即可 | 反复调模型，费 Token | 人工时间成本 |
| **适用范围** | 研究、教学、架构、方案、创作 | 文档内嵌简单图 | 插画/氛围图 | 白板 brainstorm、正式制图 |
